			...
			if (createEmployee.is_open()) { // write to the file
				...
				if (monthOrWeekly == "weekly") {
					...
					createEmployee << employeeFirst << "," << employeeLast << "," << employeeUser << "," <<
						employeePass << "," << currentUser[0] << " " << currentUser[1] << "," << marriedSingle << "," << employeeTitle << "," << monthOrWeekly << ","
						<< getCurrentDay(weekDay) << "," << employeeHourlyRate << "," << "0.00";
				...
				if (monthOrWeekly == "monthly") {
					...
					createEmployee << employeeFirst << "," << employeeLast << "," << employeeUser << "," <<
						employeePass << "," << currentUser[0] << " " << currentUser[1] << "," << marriedSingle << "," << employeeTitle << "," << monthOrWeekly << "," << monthlyPayDay << "," << employeeHourlyRate << "," << "0.00";
	...
	if (numOfEmployee > 0) { // gets the employee info of the selected employee
		...
		while (isFinish == 1) {
			...
			if (userChoice == 2) {
				...
				newData += maritalStatus + "," + employeeInfo[6] + ","
					+ employeeInfo[7] + "," + employeeInfo[8] + "," + employeeInfo[9] + "," + employeeInfo[10];
